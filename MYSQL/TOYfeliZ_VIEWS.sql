...
SELECT a.ID_CARRITO, a.ID_JUGUETE, a.cantidadCompra, b.ID_CLIENTE, c.nombre, c.precio FROM poductoscarrito a INNER JOIN carrito b ON b.ID_CARRITO = a.ID_CARRITO
